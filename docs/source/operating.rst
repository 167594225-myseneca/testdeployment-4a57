[testdeployment-4a57] Operating Details
====================================
...
.. important::
   ...
   **not be valid if your [testdeployment-4a57] container is NOT running**.

.. tip::
   You must have your [testdeployment-4a57] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   https://github.com/167594225-myseneca/cyt160-raspberrypi/blob/main/tml-airflow/logs/logs.txt
...
.. important::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/167594225-myseneca/cyt160-raspberrypi.git  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=33235  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='167594225-myseneca'  \-\-env DOCKERUSERNAME='xXjona18Xx'  \-\-env MQTTUSERNAME='xXjonaXx'  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. list-table::
   ...
   * - \-\-env KAFKACLOUDPASSWORD
     - This is your API Secret from Confluent Cloud.
   * - xXjona18Xx/testdeployment-4a57-amd64
...
[testdeployment-4a57] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/167594225-myseneca/cyt160-raspberrypi/tree/main/tml-airflow/dags/tml-solutions/testdeployment-4a57
...
.. important::
   solution_preprocessing_dag-testdeployment-4a57
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=59655, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=44017, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=33573, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=42645, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=38053, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=38759, HPDEHOST=127.0.1.1, HPDEPORT=33717, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=37981

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-6195-testdeployment-4a57,solution_preprocessing_dag-testdeployment-4a57, python-preprocess-6458-testdeployment-4a57,solution_preprocessing_dag-testdeployment-4a57, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
